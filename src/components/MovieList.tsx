      ...
      <div className="mb-6">
        ...
        <div className="mt-3 space-y-2">
          ...
          <div className="flex flex-wrap gap-2">
            {['mindblow', 'sci-fi', 'action', 'comedy', 'drama', 'horror', 'thriller', 'komplexe-handlung', 'zeitreise'].map((tag) => (
              <button
                key={tag}
              ...
              {movie.tags.length > 0 && (
                <div className="flex flex-wrap gap-1 mb-3">
                  {movie.tags.map((tag) => (
                    <span
                      key={tag.id}
                      className="px-2 py-1 text-xs rounded-full text-white cursor-pointer"
